...
export class CurriculumService {
  ...
  async regenerateOneWeekFromGoal(input: RegenerateOneWeekCurriculumInput): Promise<Curriculum> {
    const replacement = await this.generateOneWeekFromGoal(input);
...
function assertSevenDayPlan(generated: OneWeekCurriculumOutput): void {
  if (generated.duration_days !== 7 || generated.days.length !== 7) {
    throw new Error("One-week curriculum must contain exactly seven day plans before persistence");
  }
}
